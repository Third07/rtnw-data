...
function getUnlockLimit(e) {
    const t = state.data && state.data[e];
    const n = t && Number(t.skill_point_limit);
...
function renderJobSection(e, t, n) {
    ...
    const i = getPointsSpentInJob(t.job_id), o = getUnlockLimit(t.job_id), s = getJobIconPath(t.job_icon_big || t.job_icon, !t.job_icon_big), a = resolveJobDisplayName(t);
    const overLimit = i > o;
    l.innerHTML = `\n        <div class="job-header-banner">\n            <img src="${s}" alt="${a}" class="job-icon-large" \n                 onerror="this.style.display='none'">\n            <div class="job-info">\n                <h2>${a}</h2>\n                <div class="job-points">\n                    Points: <span class="highlight ${overLimit ? "text-danger" : ""}" style="${overLimit ? "color: red;" : ""}">${i}</span> / ${o}\n                </div>\n            </div>\n        </div>\n        <div class="job-skills-container id-${t.job_id}">\n        </div>\n    `, 
