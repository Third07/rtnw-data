...
const GRID_COLUMNS = 5, ICON_PATHS_URL = "sea/icon_paths.json", SKILLS_INDEX_URL = `sea/skills_index_${ACTIVE_LOCALE}.json`, JOB_DATA_URL = e => `sea/jobs_${ACTIVE_LOCALE}/${e}.json`, JOB_SELECTION_PLACEHOLDER_BY_LOCALE = {
    "zh-TW": "選擇職業...",
